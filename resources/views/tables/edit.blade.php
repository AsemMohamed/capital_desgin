...
@section('tableA')
    ...
    <form method="post" action="{{ route('tables.update', $tables->id) }}" class="form-horizontal" enctype="multipart/form-data">
        {{--@csrf--}} {{ csrf_field() }}
        {{-- @method('PATCH')--}}
        {{ method_field('PATCH') }}
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" name="name" value="{{ $tables->name }}" class="form-control input-lg" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-4 text-right">Price</label>
            <div class="col-md-4">
                <input type="text" name="price" value="{{ $tables->price }}" class="form-control input-lg" />
            </div>
        </div>
        {{--<div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" name="type" value="{{ $tables->type }}" class="form-control input-lg" />
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" name="seo" value="{{ $tables->seo }}" class="form-control input-lg" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-4 text-right">Height</label>
            <div class="col-md-4">
                <input type="text" name="height" value="{{ $tables->height }}" class="form-control input-lg" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-4 text-right">Length</label>
            <div class="col-md-4">
                <input type="text" name="length" value="{{ $tables->length }}" class="form-control input-lg" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-4 text-right">Width</label>
            <div class="col-md-4">
                <input type="text" name="width" value="{{ $tables->width }}" class="form-control input-lg" />
            </div>
        </div>
        <br />
        <div class="form-group">
            ...
            <div class="col-md-4">
                ...
                <img src="{{ URL::to('/') }}/images/{{ $tables->image }}" class="img-thumbnail" width="100" />
                <input type="hidden" name="hidden_image" value="{{ $tables->image }}" />
            </div>
        </div>
        <br /><br /><br />
        <div class="form-group text-center">
            <input type="submit" name="edit" class="btn btn-primary btn-lg" value="Edit" />
            <a href="{{route('tables.index') }}" type="button" class="btn btn-danger btn-lg">back</a>
        </div>
    </form>
