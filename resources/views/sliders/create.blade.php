...
<div class="container">
    ...
    <form class="form-horizontal" method="post" action="{{route('sliders.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <textarea name="description" id="desc" cols="122" rows="5"></textarea>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="col-md-12 text-center">
            <button type="submit" class="btn btn-primary btn-lg" class="col-md-8" href="{{route('sliders.index') }}">Save</button>
