...
@section('diningB')
    ...
    <form class="form-horizontal" method="post" action="{{route('dinings.store') }}" enctype="multipart/form-data">
        {{--@csrf--}} {{ csrf_field() }}
        ...
        <div class="col-md-12 text-center">
            <button type="submit" class="btn btn-primary btn-lg" class="col-md-8" href="{{route('dinings.index') }}">Save</button>
            <a href="{{route('dinings.index') }}" class="btn btn-danger btn-lg">back</a>
        </div>
