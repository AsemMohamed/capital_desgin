...
<section id="page-body" class="notoppadding">
    ...
    <div id="portfolio-grid" class="isotope-grid blog-container style-column-3 fitrows isotope-spaced">
            ...
            <div class="isotope-item blog-item">
                <div class="blog-media">
                    <a href="{{url('gallery')}}" class="thumb-overlay">
                        <img src="{{asset('images')}}/{{ $dining->image }}" alt="{{ $dining->seo }}">
                    </a>
                </div>

                <div class="blog-desc align-center">
                    <div class="blog-headline">
                        <h6 class="post-category uppercase">{{ $dining->type }}</h6>
                        <h6>Height: {{ $dining->height }}<br>
                            Length: {{ $dining->length }}<br>
                            Width:  {{ $dining->width }}</h6>
                        <h5 class="post-name"><a href="blog-single-custom1.html"><strong>{{ $dining->name }}</strong></a></h5>
                        <h5 class="post-date"  style="color: green">{{ $dining->price }} L.E</h5>
                    </div>
                    <ul class="blog-meta">
        ...
        @endforeach
    </div> <!-- END #portfolio-grid .isotope-grid -->    <div class="spacer-medium"></div>
</section>
<!-- PAGEBODY -->
