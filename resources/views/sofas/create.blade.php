...
@section('sofaB')
    ...
    <form class="form-horizontal" method="post" action="{{route('sofas.store') }}" enctype="multipart/form-data">
        {{--@csrf--}} {{ csrf_field() }}
        ...
        <div class="col-md-12 text-center">
            <button type="submit" class="btn btn-primary btn-lg" class="col-md-4" href="{{route('sofas.index') }}">Save</button>
            <a href="{{route('sofas.index') }}" class="btn btn-danger btn-lg">back</a>
        </div>
