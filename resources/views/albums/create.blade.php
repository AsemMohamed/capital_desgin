    ...
    <div class="container">
        ...
        <form class="form-horizontal" method="post" action="{{route('albums.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <select class="form-control" name="category">
                        ...
                        <option value="d'inings">Dinings</option>
            ...
            <div class="col-md-12 text-center">
                <button type="submit" class="btn btn-primary btn-lg" class="col-md-8" href="{{route('albums.index') }}">Save</button>
                <a href="{{route('albums.index') }}" class="btn btn-danger btn-lg">back</a>
            </div>
