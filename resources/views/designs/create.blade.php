...
@section('designA')
    ...
    <form class="form-horizontal" method="post" action="{{route('designs.store') }}" enctype="multipart/form-data">
        {{--@csrf--}} {{ csrf_field() }}
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <input type="txt" name="type" class="form-control input-lg">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="col-md-12 text-center">
            <button type="submit" class="btn btn-primary btn-lg" class="col-md-8" href="{{route('designs.index') }}">Save</button>
            <a href="{{route('designs.index') }}" class="btn btn-danger btn-lg">back</a>
        </div>
